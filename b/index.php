...
// get business_itemseq
$uri = $_SERVER['REQUEST_URI'];
// echo $uri."<br>";

$biz_itemseq = substr($uri, strrpos($uri, '?')+1);
// echo $biz_itemseq."<br>";

$sUrl = "http://175.41.147.225/v2/snap/web/snapshot_item/?business_itemseq=".$biz_itemseq."&langcd=".$langcd."&jsoncallback=none";
// echo $sUrl."<br>";
...
<meta name="twitter:image" content=<?php echo '"'.$jsonObject->snap_url.'"'?>>
<meta name="twitter:site" content="@Snapeee_com">
<meta name="twitter:title" content="Snapeee Photo">
<meta name="twitter:description" content=<?php echo '"'.$jsonObject->title.'"'?>>
...
<div id="wrapper"><!-- wrapper start -->
    ...
    <header id="header"><!-- header start -->
        <img src="http://snape.ee/img/snapshot/img_logoL.png" class="logo" />
    
        <div class="lang pc"><p><a href="#" class="current" id="click_ja" style="display:">日本語</a> / <a href="#" id="click_en">English</a></p></div>
        <a href="http://snape.ee/link/dl.html" target="_blank" style="float:right; margin:5px 8px"><img src="http://snape.ee/img/snapshot/bnr_downloadapp_en.png" width="198" class="en sp"/><img src="http://snape.ee/img/snapshot/bnr_downloadapp_ja.png" width="198" class="ja sp" /></a>
    </header> <!-- header end -->
    ...
    <div id="content"><!-- content start -->
        ...
        <img id="loading_img" class="loading"　/>
            <img id="photosp" class="sp" src="http://snape.ee/img/snapshot/placeholder.png" />
            <br class="clear" />
            ...
            <div class="username">
                ...
                <p><span class="ja">招待コード</span><span class="en">Invitation Code</span> : <span id="invite_cd"><?php echo $jsonObject->invite_cd;?></span></p>
            </div>
        ...
        <div id="rightcontent"><!-- right content star -->
        <img src="http://snape.ee/img/snapshot/img_aboutsnapeee.png" class="pc ja" />
        <img src="http://snape.ee/img/snapshot/img_aboutsnapeee_sp.png" class="sp ja" width="100%" />
        <img src="http://snape.ee/img/snapshot/img_aboutsnapeee_en.png" class="pc en" />
        <img src="http://snape.ee/img/snapshot/img_aboutsnapeee_en_sp.png" class="sp en" width="100%" />
        <p class="ja"><span class="pink">招待コード</span><span class="pink" id="right_inv_cd1"><?php echo $jsonObject->invite_cd;?></span>を入れて始めると<span id="right_user_nm1"><?php echo $jsonObject->user_nm;?></span>さんを簡単にフォローできたり、もっとSnapeeeを楽しめるポイントをプレゼント！</p>
        <p class="en">Start Snapeee with <span class="pink">Invitation Code</span><span class="pink" id="right_inv_cd2"><?php echo $jsonObject->invite_cd;?></span> to follow <span id="right_user_nm2"><?php echo $jsonObject->user_nm;?></span> and get special Point to download more decorations!</p>
